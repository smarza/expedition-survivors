...
namespace ProjectExpedition
{
    public static class RunModalPresentation
    {
        ...
        public static void DrawResultsShell(Rect panel, SurvivorsHudStyles styles, string title)
        {
            SurvivorsStylePresentation.DrawFlatPanel(panel, SurvivorsStylePresentation.PanelNavy, 2f,
                SurvivorsStylePresentation.BorderGold);
            GUI.Label(new Rect(panel.x + 24f, panel.y + 24f, panel.width - 48f, 48f), title, styles.Title);
        }
